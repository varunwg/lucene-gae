...
public class DataStoreFileIndexInput extends IndexInput {
	...
	public DataStoreFileIndexInput(DataStoreFile file) throws IOException {
		this.file = file;
	...
	private byte[] readFromFile(int len) {
		...
		while (begin < end) {
			...
			int canRead = DataStoreFileUtils.MAX_SIZE - start;
